		...
		for i, row in enumerate(self):
			...
			if row.isBorderOnly:
				if i == 0 and lastrow:
					...
					# JAM: Attempt to preserve trailing hlines in the source.
					# These properly style in the style attribute of the cells, but our imaging
					# process depends on the source being correct, which means we need hlines.
